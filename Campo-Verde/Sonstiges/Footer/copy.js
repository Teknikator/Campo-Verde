...
copyh5.appendChild(document.createTextNode('© Copyright 2022 - 2024 Campo Verde'));



//Halte Copy Datum Aktuell

document.getElementById("copyh5").innerHTML = "© Copyright  2022 - " + new Date().getFullYear() + " campo verde";
...
copyVa.appendChild(document.createTextNode('Version 0.8'));
...
copyD.setAttribute('href', 'https://teknikator.de')
